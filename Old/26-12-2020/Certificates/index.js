...
cer=()=>
{
	...
	if(s.match(/^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i))
	{
		s=hsh(s.toLowerCase())
		console.log(s)
		if(['me1136','in1692','pr1943','ma1280','dh1461','ma1690','ak1580','ga1503','pr1804','aa1555','ab1795','mn1003','ak1749','ak1315','1t1479','ka1478','su1422','mu1827','sa1230','ya1640','sp934','ra1779','ku1380','vi1958','ar1488','sk930','ma1351','ak1579','pa1925','pr1600','ni1509','ra1511','sa1579','ga1785','ro1386','rk1399','281267','sa1785','mi1344','sk910','ri1433','gk875','aa1545','ra1264','am1285','pr1728','js929','am1436','as1359'].includes(s))
